...
const COMPACT_THRESHOLD = 100000; // tokens — compact only above 100k (most free models handle this)
const KEEP_RECENT_TOKENS = 40000; // tokens — recent messages kept untouched (preserve session context)
const SUMMARY_MAX_TOKENS = 1500;  // tokens — summary length cap (detailed enough to not lose the work)
