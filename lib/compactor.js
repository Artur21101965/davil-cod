...
const COMPACT_THRESHOLD = 256000; // tokens — compact only above 256k (most free models hold 131k-1M)
const KEEP_RECENT_TOKENS = 80000; // tokens — recent messages kept untouched (preserve session context)
