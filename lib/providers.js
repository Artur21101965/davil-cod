...
const MODEL_MAP = {
  ...
  'tier-splus': 'or-nemotron-35', 'tier-s': 'mistral-codestral',
  'tier-a': 'mistral-small', 'tier-b': 'groq-qwen',
  'tier-xl': 'or-dots-3', 'tier-l': 'or-nemotron-35',
...
module.exports = { PROVIDERS, MODEL_MAP, callProvider, reloadProviders };
