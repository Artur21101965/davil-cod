  ...
  <title>Freegate — Панель управления</title>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .side-logo { width: 26px; height: 26px; border-radius: 7px; background: var(--accent); display: grid; place-items: center;
      color: #fff; font-weight: 800; font-size: 14px; box-shadow: 0 0 0 3px rgba(124,92,255,.18); }
    ...
    .tab.active::before { background: var(--accent); opacity: 1; box-shadow: 0 0 0 3px rgba(124,92,255,.2); }
    ...
    #topbar { position: sticky; top: 0; z-index: 10; background: rgba(13,13,15,.9); backdrop-filter: blur(10px);
    ...
    .dot.bad { background: var(--err); box-shadow: 0 0 0 3px rgba(248,113,113,.2); }
    ...
    .kpi-chip.warn, .kpi-chip.err { border-color: rgba(251,191,36,.4); }
    .kpi-chip.err { border-color: rgba(248,113,113,.4); }
    ...
    .alert.err { border-color: rgba(248,113,113,.35); color: #fbc4c4; }
    .alert.warn { border-color: rgba(251,191,36,.35); color: #fde9b8; }
    .alert.ok { border-color: rgba(74,222,128,.35); color: #b7efcd; }
    ...
    .chip.active { color: #fff; border-color: var(--accent); background: rgba(124,92,255,.16); }
    ...
    .badge.up, .badge.active { background: rgba(74,222,128,.12); color: var(--ok); }
    .badge.ratelimited { background: rgba(251,191,36,.12); color: var(--warn); }
    .badge.error, .badge.dead { background: rgba(248,113,113,.12); color: var(--err); }
    .badge.unknown, .badge.untested { background: rgba(154,154,162,.14); color: var(--muted); }
    .badge.disabled, .badge.user-disabled { background: rgba(154,154,162,.1); color: var(--muted); }
    ...
    .rec-badge.ok { background: rgba(74,222,128,.12); color: var(--ok); }
    .rec-badge.warn { background: rgba(251,191,36,.12); color: var(--warn); }
    .rec-badge { background: rgba(154,154,162,.14); color: var(--muted); }
